...
import { n as ThermalMap, o as getRouteForecast, t as ThermalLegend } from "./fortyguard-BUEdrfTf.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/heat-intelligence-BIK7Ksht.js
...
function HeatIntelligence() {
	...
	const currentTemp = nowSlot?.peakTempC ?? 28;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			...
			children: [!loading && !routeContext ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			}) : loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "glass-panel rounded-3xl p-12 text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "mx-auto h-8 w-8 animate-spin text-primary" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-4 font-display text-lg font-bold",
						children: "Loading Heat Intelligence"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-1 text-xs text-muted-foreground",
						children: "Reading FortyGuard 2m thermal resolution grid and 12-hour outlook..."
					})
				]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [nowSlot && nowSlot.available && nowSlot.peakTempC !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DepartureCard, {
